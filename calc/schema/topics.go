...
// Topics maps function/constant/command names to one-line documentation.
var Topics = map[string]string{
	...
	"stirling":          "stirling(n, k): Stirling 2nd kind (stirling(4, 2)=7)",
	"derangements":      "derangements(n): subfactorial !n (derangements(4)=9)",
	"lucas":             "lucas(n): Lucas number (lucas(4)=7)",
	"digitproduct":      "digitproduct(n): product of decimal digits (digitproduct(123)=6)",
	...
	"nextperfect":       "nextperfect(n): smallest perfect >= n (nextperfect(7)=28)",
	...
	"e":                 "e: the constant e",
	"commands":          "commands: help, vars, history, status, last, reset, clear, undo, redo, deg, rad, grad, sci, fix, eng, std, prec, mem, ms, m+, m-, mr, mc, schema, quit",
	"schema":            "schema: print the full machine-readable JSON language schema (functions, constants, commands, operators, modes, CLI flags)",
